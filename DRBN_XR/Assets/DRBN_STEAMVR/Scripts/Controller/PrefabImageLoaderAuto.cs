...
//     public string xmlFilePath = "Resources/XML/PrefabList.xml"; // Chemin relatif au répertoire Assets
...
//             string fullPath = Path.Combine(Application.dataPath, "Resources", imagePath, imageName + ".png");
